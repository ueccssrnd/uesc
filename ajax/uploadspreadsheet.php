...
if(isset($_SESSION['agent'])&&$_SESSION['agent']==md5($_SERVER['HTTP_USER_AGENT'])&&isset($_SESSION['type'])&&($_SESSION['type']=='Administrator'||$_SESSION['type']=='Facilitator')){
    ...
    // Settings
    $targetDir = '..'. DIRECTORY_SEPARATOR."data".DIRECTORY_SEPARATOR."spreadsheets";
    //$targetDir = 'uploads';
    ...
    if ($chunks < 2 && file_exists($targetDir . DIRECTORY_SEPARATOR . $fileName)) {
            ...
            rename($targetDir . DIRECTORY_SEPARATOR . $fileName, $targetDir . DIRECTORY_SEPARATOR . $fileName_a . '_' . $count . $fileName_b);
    }
