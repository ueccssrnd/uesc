...
<html>
    <head>
        ...
        <title>UESC Election | Admin Login</title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="subheader">Admin Login</div>
            <span id="corner"></span>
            <div id="sidebar">
                <form method="post" class="sidebarForm" id="frmLogin" action="election.php">
                    <input type="hidden" id="category" name="category" value="USC" />
                </form>
                    <div class="fieldDescription">Username</div>
                    <input type="text" class="sidebarInputField" id="username" maxlength="15" />
                    <div class="fieldDescription">Password</div>
                    <input type="password" class="sidebarInputField" id="password" maxlength="15" />
